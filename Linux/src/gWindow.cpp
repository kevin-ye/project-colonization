...
gWindow::gWindow(mLock *main_thread_ready_lock) : _window(new tWindow()), _control(NULL)
{
	init();
...
{
	_thread = new thread(gWindow::main, this, main_thread_ready_lock);
}
