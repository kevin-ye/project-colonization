...
gameControl::gameControl(): eventqueue_lock(new mLock()), window_readylock(NULL), _window(NULL)
{
...
void gameControl::setgWindow(class gWindow *_w, mLock *ml)
{
	_window = _w;
	window_readylock = ml;
}
